...
r = ShowapiRequest("http://route.showapi.com/950-1","85230","c27c14e333a248cebf16385de77f84a9" )
r.addBodyPara("num", "5")
r.addBodyPara("type", "1")
r.addBodyPara("yayuntype", "1")
r.addBodyPara("key", "易源接口")
res = r.post()
pprint(r.get().json()['showapi_res_body'])
